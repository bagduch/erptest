<div class="account-wrap">
    ...
    {include file="$template/clientareasupportlinks.tpl"}
    <div class="row details">
        ...
        <form method="post" class="form-inline" action="supporttickets.php">
            ...
            <div class="col-lg-8">
                <a class="btn btn-primary btn-sm pull-right" href="submitticket.php"><span aria-hidden="true" class="icon-plus"></span> {$LANG.opennewticket}</a>
            </div>
        </div>        
        </form>

...
if ($step == "2" && $type == "configoptions") {
	foreach ($configoption as $optionid => $newqty) {
		$result = select_query("tblserviceconfigoptions", "", array("id" => $optionid));
		$data = mysql_fetch_array($result);

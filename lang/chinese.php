...
$_LANG['affiliatesactivate'] = "激活联盟账户，开始赚钱";
...
$_LANG['clientareaaddfundsdisabled'] = "我们不允许提前与我们在当前时间存入资金。";
...
$_LANG['clientareacancelconfirmation'] = "您的取消请求已经被提交。如果您的这个请求是错误的，请立刻提交一个服务单通知我们，否则您的账号可能被删除。";
...
$_LANG['clientareacontactsemailssupport'] = "支持Email - 服务单通知";
...
$_LANG['clientareanavlogout'] = "注销/退出";
...
$_LANG['creditcardconfirmation'] = "您的新的信用卡信息被接受并且您账号的首次付款已经完成。一封确认电子邮件已经发给您。";
...
$_LANG['domaingeteppcodefailure'] = "领取域名转移码时Warning：";
...
$_LANG['invoiceserror'] = "Warning，请重试。";
...
$_LANG['loginforgotten'] = "忘记密码/找回密码";
$_LANG['loginforgotteninstructions'] = "忘记密码/找回密码";
...
$_LANG['orderfinalinstructions'] = "如果您对您的订单有任何疑问，请您在客户中心提交一个服务单并提供您的订单号码.";
$_LANG['orderfree'] = "免费！";
...
$_LANG['ssladmininfodetails'] = "以下联络资料将不会显示在证书上 - 它是只用于本订单联系您。这个SSL证书和未来更新提醒我们将发送到以下指定的电子邮件地址。";
...
$_LANG['supportticketsdescription'] = "查看并回复服务单";
$_LANG['supportticketserror'] = "错误";
$_LANG['supportticketserrornoemail'] = "您没有填写您的Email";
...
$_LANG['supportticketsnotfound'] = "未找到服务单";
$_LANG['supportticketsopentickets'] = "打开服务单";
...
$_LANG['supportticketsstatuscloseticket'] = "如果问题已经解决，您可以点击这里关闭服务单";
...
$_LANG['supportticketssystemdescription'] = "服务单系统能够让我们很快的响应您的问题.当我们回复您的服务单时，您将收到一封电子邮件通知.";
$_LANG['supportticketsticketattachments'] = "附件";
$_LANG['supportticketsticketcreated'] = "服务单已创建";
$_LANG['supportticketsticketcreateddesc'] = "您的服务单成功创建.一封关于服务单信息的电子邮件已经发送给您。您现在就可以去查看这个服务单.";
$_LANG['supportticketsticketid'] = "服务单编号";
...
$_LANG['transferdomaindesc'] = "想转移域名到我们？请在下面输入域名来开始转移。";
...
$_LANG['upgradedowngradepackage'] = "升级/降级方案";
...
$_LANG['varilogixfraudcall_error'] = "Warning，我们无法给您拨打电话证实您的订单，请尽快联系我们的支持部门以完成您的订单。";
...
$_LANG['recaptcha-invalid-site-private-key'] = "Warning，请联系支持（错误代码：CAP1）";
$_LANG['recaptcha-invalid-request-cookie'] = "Warning，请重试（错误代码：CAP2）";
...
$_LANG['domaincheckerdomainexample'] = "例如：mtimer.cn";
...
$_LANG['nosupportdepartments'] = "暂无支援部门。请稍后再试一次.";
...
$_LANG['twofaactivationerror'] = "尝试启动时Warning".$_LANG['twofactorauth']." 您的帐户。请再试一次.";
$_LANG['twofamoduleerror'] = "加载模块时Warning。请再试一次.";

...
$search = $ra->get_req_var("search");
$domain = $ra->get_req_var("domain");
$bulkdomains = $ra->get_req_var("bulkdomains");
$tld = $ra->get_req_var("tld");
$tlds = $ra->get_req_var("tlds");
$ext = $ra->get_req_var("ext");
$direct = $ra->get_req_var("direct");
$sld = "";
$invalidtld = "";
...
if ($ra->get_config("BulkDomainSearchEnabled")) {

...
//$result = select_query("tblhosting", "tblhosting.*,tblservices.servertype,tblservices.type", array("tblhosting.id" => $id), "", "", "", "tblservices ON tblservices.id=tblhosting.packageid");

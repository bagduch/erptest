                ...
                <div class="box-body">
                    <form method="post" action="/admin/clientsprofile.php?save=true&amp;userid={$clientsdetails.userid}">
                        <table class="table" width="100%" border="0" cellspacing="2" cellpadding="3">
                            <tbody><tr><td width="10%" class="fieldlabel">First Name</td>
                                    <td class="fieldarea" width="25%"><input class="form-control"  type="text" size="30" name="firstname" value="{$clientsdetails.firstname}" tabindex="1"></td>
                                    <td class="fieldlabel" width="10%">Address 1</td>
                                    <td class="fieldarea" width="25%"><input class="form-control"  type="text" size="30" name="address1" value="{$clientsdetails.address1}" tabindex="8"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="fieldlabel">Address 2 <font color="#cccccc"><small>(Optional)</small></font></td>
                                    <td class="fieldarea"><input class="form-control"  type="text" size="30" name="address2" value="{$clientsdetails.address2}" tabindex="9"> 

                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldlabel">Company Name <font color="#cccccc"><small>(Optional)</small></font></td>
                                    <td class="fieldarea">
                        ...
                        <div align="center"><input type="submit" value="Save Changes" class="btn btn-primary" tabindex="1"> <input type="reset" value="Cancel Changes" class="btn btn-default" tabindex="2"></div>
                    </form>
                </div>
            </div>
        </div>

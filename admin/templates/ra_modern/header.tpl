...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="templates/{$template}/bootstrap/css/bootstrap.min.css">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
        <!-- Ionicons -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
        <!-- Theme style -->
        <link rel="stylesheet" href="templates/{$template}/dist/css/AdminLTE.min.css">
        <!-- AdminLTE Skins. Choose a skin from the css/skins
             folder instead of downloading all of them to reduce the load. -->
        <link rel="stylesheet" href="templates/{$template}/dist/css/skins/_all-skins.min.css">
        <!-- iCheck -->
        ...
        <!-- jvectormap -->
        <link rel="stylesheet" href="templates/{$template}/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
        <!-- Date Picker -->
        <link rel="stylesheet" href="templates/{$template}/plugins/datepicker/datepicker3.css">
        <!-- Daterange picker -->
        <link rel="stylesheet" href="templates/{$template}/plugins/daterangepicker/daterangepicker.css">
        ...
        <script src="templates/{$template}/dist/js/pages/dashboard2.js"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="templates/{$template}/dist/js/demo.js"></script>

    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="search">
            <form method="post" action="{$PHP_SELF}">
                ...
                <div align="center"><input type="submit" value="Search/Filter" class="button"></div>
        ...
        <div role="tabpanel" class="tab-pane" id="addtransaction">
            ...
            <form method="post" action="{$PHP_SELF}?action=add" name="calendarfrm">
                    ...
                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fieldarea"><input class="form-control" type="checkbox" name="addcredit"> Add to Client's Credit Balance</td>
                            </tr>
                            <tr>
                ...
                <img src="images/spacer.gif" height="10" width="1"><br>
                <div align="center"><input type="submit" value="Add Transaction" class="button"></div>
            </form>

...
<div class="header">
<div class="logo"><a href="index.php"><img width="85px" height="85px" src="templates/{$template}/images/logo.png" border="0" /></a></div>
...
{if $helplink}<div class="contexthelp"><a href="http://docs.ra.com/{$helplink}" target="_blank"><img src="images/icons/help.png" border="0" align="absmiddle" /> {$_ADMINLANG.help.contextlink}</a></div>{/if}

            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <ul>
                        ...
                        <li><a href="#" onClick="showDialog('addfunds');
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <ul>
                        ...
                        <li><a href="#" onClick="window.open('clientsmerge.php?userid={$clientsdetails.userid}', 'movewindow', 'width=500,height=280,top=100,left=100,scrollbars=1');
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="clientsproducts col-lg-12">
                <div class="box box-primary">
                    <div class="box-heading"><div class="box-title">

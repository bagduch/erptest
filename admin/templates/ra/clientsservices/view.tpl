...
<div class="box box-primary">
    <div class="box-header">
        ...
        <a style="float:right" href="#" class="btn btn-danger" onclick="deleteaccount({$id});">Delete</a>
        <a style="float:right;margin-right:10px" class="btn btn-primary" href="ordersadd.php?userid={$userid}">Add new Order</a>
    </div>
    <div class="box-body">

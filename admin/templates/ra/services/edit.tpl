    ...
    <form method="post" action="/admin/configservices.php?action=save&amp;id=3" name="packagefrm">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="links">
                <div class="panel-body">
                    <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tbody><tr><td class="fieldlabel">Direct Shopping Cart Link</td><td class="fieldarea"><input class="form-control" type="text" size="100" value="https://dev.roboticaccounting.com/cart.php?a=add&amp;pid={$data.id}" readonly=""></td></tr>
                            <tr><td class="fieldlabel">Direct Shopping Cart Link Specifying Template</td><td class="fieldarea"><input class="form-control" type="text" size="100" value="https://dev.roboticaccounting.com/cart.php?a=add&amp;pid={$data.id}&amp;carttpl=cart" readonly=""></td></tr>
                            <tr><td class="fieldlabel">Direct Shopping Cart Link Including Domain</td><td class="fieldarea"><input class="form-control" type="text" size="100" value="https://dev.roboticaccounting.com/cart.php?a=add&amp;pid={$data.id}&amp;sld=ra&amp;tld=.com" readonly=""></td></tr>
                            <tr><td class="fieldlabel">Service Group Cart Link</td><td class="fieldarea"><input class="form-control" type="text" size="100" value="https://dev.roboticaccounting.com/cart.php?gid={$data.gid}" readonly=""></td></tr>
                        </tbody></table>
                </div>

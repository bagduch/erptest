...
if (!($ra instanceof RA_Init)) {
	exit("Failed to initialize application.");
}

$licenseerror = $ra->get_req_var("licenseerror");
...
<body>
    <div id=\"l";
echo "ogo\">
        <a href=\"login.php\"><img src=\"images/loginlogo.png\" alt=\"ra\"
            border=\"0\" /></a>
    </div>
...
";
		...
		if ($licenseerror == "invalid") {
			...
			echo "   If required, you can reissue your license on-demand from our client
                area @ <a href=\"https://www.ra.com/members/clientarea.php\"
                    target=\"_blank\">www.ra.com/members/clientarea.php</a> which will
...
";
            ...
            <ul>
                ...
                <li>Order a new license from <a href=\"http://www.ra.com/order/\"
                    target=\"_blank\">www.ra.com/order</a></li>
            </ul>
            <p>
                If you feel this message to be an error, please contact us @ <a";
				echo "
                    href=\"http://www.ra.com/get-support\" target=\"_blank\">www.ra.com/get-support</a>
            </p>
            <p>
                Got a new license key? <a
                    href=\"licenseerror.php?licenseerror=change\">Click here to enter it</a>
...
";
                ...
                use this version of ra, you first need to renew your support &
                updates access. You can do this from our client area @ <a
                    href=\"https://www.ra.com/members/clientarea.php\" target=\"";
					echo "_blank\">www.ra.com/members/clientarea.php</a>
            </p>
            <p>
                If you feel this message to be an error, please contact us @ <a
                    href=\"http://www.ra.com/get-support\" target=\"_blank\">www.ra.com/get-support</a>
...
";
					...
					if ($licenseerror == "noconnection") {
						echo "<p>ra has not been able to verify your license for the last few days.</p>
            <p>Before you can access your ra Admin Area again, the license
            ...
            <p>
                For further assista";
                    ...
                    href=\"http://docs.ra.com/Licensing#Common_Errors\"
                    target=\"_blank\">http://docs.ra.com/Licensing</a>
            </p>
";
					}
					else {

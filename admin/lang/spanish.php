...
$_ADMINLANG['domains']['leaveatzero'] = "Dejar registro en 0 para desactivar ese término. Establecer Transferencia/Renovar a -1 para deshabilitar";
...
$_ADMINLANG['support']['permissionswarninfo'] = "ra no puede escribir en el directorio de descargas, así que no es posible subir archivos";
...
$_ADMINLANG['support']['spamupdatesuccessinfo'] = "La dirección de correo  se ha añadido a la lista de remitentes bloqueados";
...
$_ADMINLANG['help']['forums'] = "Foros ra";
...
$_ADMINLANG['addonmodules']['description'] = "Desde aquí puede activar y gestionar los módulos extra de su ra. El 'modo compatibilidad' le permite activar/desactivar módulos y configurar derechos de acceso, pero no mostrará ninguna opción de configuración, versión o información del autor.";
...
$_ADMINLANG['products']['selectfreedomainpayterms'] = "TLD's para Dominios Gratis";
$_ADMINLANG['products']['selectfreedomainpayterms'] = "TLD's para Dominios Gratis";
...
$_ADMINLANG['adminroles']['description'] = "Los roles de administradores le permite especificar exactamente qué puede hacer cada administrador dentro del área de administración de ra.";
...
# Payment Gateways
$_ADMINLANG['gateways']['intro'] = "Aquí es donde se configuran los métodos de pago/gateways que desea ofrecer y aceptar de sus clientes. Si la pasarela de pagos que desea utilizar no aparece en la lista, entonces puede crear sus propios módulos para RA- Los documentos pueden encontrarse @";
...
$_ADMINLANG['system']['integrationinfo'] = "Puede incluir estos fragmentos de HTML en su sitio web para integrarlo con el sistema ra.";
$_ADMINLANG['system']['widgetsinfo'] = "Los Widgets son otra herramienta con la que se pueden mostrar contenidos dinámicos en su sitio web desde ra. Por ejemplo, se puede mostrar la descripción y precios de productos de forma que se actualicen automáticamente al realizar cambios en ra. Para más información, acceda a";
$_ADMINLANG['system']['intclientlogin'] = "Acceso de clientes";
$_ADMINLANG['system']['intclientlogininfo'] = "Este código mostrará un formulario para que los clientes accedan al área de clientes de ra";
...
$_ADMINLANG['system']['clickhere'] = "Pulse aquí para acceder a la zona de descargas de ra";
$_ADMINLANG['system']['runninglatestversion'] = "Ya está ejecutando la versión más reciente de ra";
...
$_ADMINLANG['license']['reissue1'] = "Para mover ra a una nueva localización es necesario regenerar su licencia. Acceda a ";
...
$_ADMINLANG['mergefields']['RAurl'] = "URL de ra";
$_ADMINLANG['mergefields']['RAlink'] = "Enlace a ra";
$_ADMINLANG['mergefields']['RAadminurl'] = "URL Admin ra";
$_ADMINLANG['mergefields']['RAadminlink'] = "Enlace Admin ra";
...
$_ADMINLANG['general']['emailaddressinfo'] = "La dirección del remitente por defecto, utilizada para los correos electrónicos enviados por ra";
...
$_ADMINLANG['general']['systemurlinfo'] = "URL de la instalación de ra, por ejemplo.";
$_ADMINLANG['general']['sslurl'] = "ra SSL System URL";
$_ADMINLANG['general']['sslurlinfo'] = "URL de la instalación de ra para acceso seguro (SSL) por ejemplo. https://www.sudominio.com/members/ (Dejar en blanco si no aplica)";
$_ADMINLANG['general']['template'] = "Plantilla";
$_ADMINLANG['general']['templateinfo'] = "La plantilla que desee utilizar para ra";
...
$_ADMINLANG['general']['allowidndomainsinfo'] = "Marque esta casilla para no aplicar la validación de caracteres A-z 0-9 para dominios ingresados en el área de clientes";
$_ADMINLANG['general']['bulkdomainsearch'] = "Búsqueda masiva de dominios";
$_ADMINLANG['general']['bulkdomainsearchinfo'] = "Marque para habilitar búsquedas de dominio a través del formulario de pedido";
...
$_ADMINLANG['general']['emailglobalheader'] = "Global Email Header Contenido";
$_ADMINLANG['general']['emailglobalfooter'] = "Global Email Footer Contenido";
...
$_ADMINLANG['general']['builtin'] = "ra Sistema integrado";
...
$_ADMINLANG['general']['disablemd5'] = "Desactivar MD5 de la contraseña de clientes";
$_ADMINLANG['general']['disablemd5info'] = "ESTO NO ES RECOMENDABLE, porque las contraseñas podrían descifrarse (deshabilitar esto, restablece todas las contraseñas de clientes)";
...
$_ADMINLANG['general']['defaulttoclientareainfo'] = "Marque esta casilla para omitir la página de inicio y redirigirlos al área/inicio de sesión de cliente, cuando visitan por primera vez ra";
...
$_ADMINLANG['utilitiesresolvercheck']['delsureterminateonserver'] = "¿Está seguro de que desea hacerlo? Esto enviará el módulo de comando terminar al servidor remoto (borrará todos los archivos), así como cambiar el estado de ra a terminado para detener cualquier futura facturación.";
...
$_ADMINLANG['sendmessage']['sendingcompleted'] = "Envío de Email Completado";
...
$_ADMINLANG['ticketstatusconfig']['pagedesc'] = "Aquí puede definir los estados que los tickets mostrarán en el sistema ra. Los 4 estados por defecto son Abierto (Open), Contestado (Answered), Respuesta del Cliente (Customer-Reply) y Cerrado (Closed). Estos no se pueden Editar o Eliminar.";

...
$_ADMINLANG['addonmodules']['description'] = "Toto je místo kde můžete aktivovat a spravovat doplňkové moduly Vaši instalace ra. Starší legacy moduly Vám stále umožní aktivovat/deaktivovat a konfigutovat přístupová práva, ale nebudou zobrazeny žádné možnosti konfigurace, verzi nebo informace o autorovi.";
...
$_ADMINLANG['backups']['description'] = "V databázi jsoun uloženy všechny data ra proto je velmi důležitá. Velmi doporučujeme databázi pravidelně zálohovat. ra nabízí dvě možnosti zálohy s použitím cronu - jedna možnost je emailem a druhá pomocí FTP na vzdálený server.";
...
$_ADMINLANG['system']['integrationinfo'] = "Následující HTML kód múže být přidán do Vašeho website pro integraci s ra systémem.";
...
$_ADMINLANG['system']['intclientlogininfo'] = "Přidejte tento kód na stránku Vašeho website pro zobrazení Přihlašovacího formuláře pro přímé přihlášení klientů do klientské sekce ra";
...
$_ADMINLANG['system']['upgrade'] = "Co nejdříve by jste měli aktiualizovat ra na poslední verzi!";
$_ADMINLANG['system']['clickhere'] = "Klikněte zde pro vstup do ra Client Download Area";
$_ADMINLANG['system']['runninglatestversion'] = "Máte poslední verzi ra";
...
$_ADMINLANG['supportreq']['debuginfo'] = "Debug informaci můžete sice smazat pokud si nepřejete tuto informaci odeslat ra developerům, ale pomohlo by nám to k rychlejšímu odstranění problémů.";
...
$_ADMINLANG['license']['reissue1'] = "Pokud plánujete přesunout Váš ra systém na nové umístnění, pak musíte obnovit licenci. Podívejte se";
...
$_ADMINLANG['general']['dateformatinfo'] = "The format you want ra to use to display dates";

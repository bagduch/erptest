...
$_ADMINLANG['support']['permissionswarninfo'] = "A pasta de downloads não permite escrita pelo ra, o que impede de enviar arquivos";
...
$_ADMINLANG['help']['forums'] = "Fóruns ra";
...
$_ADMINLANG['addonmodules']['description'] = "Aqui você pode ativar e gerenciar módulos addon na sua instalação do ra. Os módulos herdados mais antigos ainda permitirão que você ative/desative e configure direitos de acesso, mas não serão capazes de exibir nenhuma opção de configuração, versão ou informações de autoria.";
...
$_ADMINLANG['adminroles']['description'] = "As funções administrativas permitem que você ajuste exatamente o que cada um dos seus usuários administradores podem fazer na área administrativa do ra.";
...
# Payment Gateways
$_ADMINLANG['gateways']['intro'] = "Aqui é onde você configura as formas/portais para pagamento que você quer oferecer & aceitar aos seus cliente. Se o portal que você quer utilizar não está listado aqui, você pode construir seus próprios módulos para RA- os manuais para isso podem ser encontrados @";
...
$_ADMINLANG['backups']['description'] = "O banco de dados é onde todos os dados do seu ra estão guardados e por isso é muito importante. É recomendado que você faça backups regulares dele. Existem dois recursos prontos para realizar a cópia de segurança do banco de dados usando as tarefas CRON diárias - um é por email e o outro é um backup em FTP para um servidor remoto. Eles podem ser configurados abaixo.";
...
$_ADMINLANG['system']['integrationinfo'] = "Os trechos de código HTML a seguir podem ser adicionados ao seu site para se integrar ao seu sistema ra.";
$_ADMINLANG['system']['widgetsinfo'] = "Widgets são outras ferramentas úteis para permitir que você adicione saídas dinâmicas ao seu website diretamente do ra. Esse recurso pode ser utilizado, por exemplo, para exibir as descrições e preços dos produtos que se atualizam automaticamente no seu site quando são feitas alterações através do ra. Para mais informações, por favor, leia";
$_ADMINLANG['system']['intclientlogin'] = "Login dos Clientes";
$_ADMINLANG['system']['intclientlogininfo'] = "Adicione esse código a uma página no seu site para exibir um formulário de login para os clientes entrarem na Área do Cliente ra";
$_ADMINLANG['system']['intdalookup'] = "Pesquisa por Disponibilidade de Domínios";
$_ADMINLANG['system']['intdalookupinfo'] = "Adicione esse código a uma página no seu site para permitir que os clientes potenciais realizem buscas por domínios utilizando o ra diretamente da página.";
...
$_ADMINLANG['system']['clickhere'] = "Clique aqui para ir para a Área de Download do Cliente ra";
$_ADMINLANG['system']['runninglatestversion'] = "Você está utilizando a última versão do ra";
...
$_ADMINLANG['license']['reissue1'] = "Se você planeja mover seu sistema ra para um novo servidor, terá que reeditar sua licença. Veja";
...
$_ADMINLANG['mergefields']['RAurl'] = "URL do ra";
$_ADMINLANG['mergefields']['RAlink'] = "Link do ra";
$_ADMINLANG['mergefields']['RAadminurl'] = "URL Admin ra";
$_ADMINLANG['mergefields']['RAadminlink'] = "Link Admin ra";
...
$_ADMINLANG['general']['emailaddressinfo'] = "O endereço de envio padrão para os emails enviados pelo ra";
...
$_ADMINLANG['general']['systemurl'] = "URL do Sistema ra";
$_ADMINLANG['general']['systemurlinfo'] = "URL da instalação do ra, ex.";
$_ADMINLANG['general']['sslurl'] = "URL SSL do Sistema ra";
$_ADMINLANG['general']['sslurlinfo'] = "URL da instalação do ra para acesso seguro, ex. https://www.seudominio.com/cliente/ (deixe em branco para não usar SSL)";
$_ADMINLANG['general']['template'] = "Modelo";
$_ADMINLANG['general']['templateinfo'] = "O modelo que você quer que o ra utilize";
...
$_ADMINLANG['general']['dateformatinfo'] = "O formato que você quer que o ra utilize para exibir datas";
...
$_ADMINLANG['general']['builtin'] = "Sistema Interno ra";
...
$_ADMINLANG['utilitiesresolvercheck']['pagedesc'] = "Esse utilitário permite que você verifique para onde aponta o endereço IP de cada domínio no seu sistema ra. Isso possibilita a você ver com facilidade quais domínios não estão mais apontando para os seus servidores e, dessa forma, identificar os clientes que não podem mais utilizar o seu serviço afim de liberar recursos.";
...
$_ADMINLANG['utilitiesresolvercheck']['delsureterminateonserver'] = "Tem certeza que você quer fazer isso? Isso enviará o comando para o módulo de encerramento ao servidor remoto (apagando todos os arquivos), assim como mudará o status no ra para Finalizado a fim de impedir qualquer cobrança futura.";
...
$_ADMINLANG['ticketstatusconfig']['pagedesc'] = "Here you can define the ticket statuses that your ra system will show. The 4 default statuses Open, Answered, Customer-Reply and Closed cannot be deleted or renamed.";

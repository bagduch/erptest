...
$_ADMINLANG['support']['permissionswarninfo'] = "Le dossier de téléchargement n'est pas accessible en écriture par RA: vous ne pouvez pas télécharger de fichier";
...
$_ADMINLANG['adminroles']['description'] = "Les rôles d'administrateur vous permettent de régler exactement ce que chacun de vos utilisateurs administrateur peut faire dans l'administration de ra.";
...
# Payment Gateways
$_ADMINLANG['gateways']['intro'] = "C'est ici que vous configurez les moyens de paiement (passerelles) que vous souhaitez offrir à vos clients. Si la passerelle que vous souhaitez utiliser n'est pas répertoriée ici, alors vous pouvez construire vos propres modules pour RA- la documentation se trouve ici : @";
...
$_ADMINLANG['system']['integrationinfo'] = "Les blocs de code HTML suivant peut être ajouté dans votre site web pour s'intégrer à votre système ra.";
$_ADMINLANG['system']['widgetsinfo'] = "Les widgets sont des outils utiles que nous fournissons pour vous permettre d'ajouter une sortie dynamique à votre site Web en direct de ra. Par exemple elles peuvent être utilisées pour afficher des descriptions de produits et de prix qui sont mis à jour automatiquement sur ​​votre site lorsque des modifications sont apportées par ra. Pour plus d'informations, s'il vous plaît voir";
$_ADMINLANG['system']['intclientlogin'] = "Connexion clients";
$_ADMINLANG['system']['intclientlogininfo'] = "Ajoutez ce code à une page de votre site pour afficher un formulaire de connexion des clients leur permettant de se connecter à l'espace client ra";
$_ADMINLANG['system']['intdalookup'] = "Recherche de disponibilité d'un domaine";
$_ADMINLANG['system']['intdalookupinfo'] = "Ajoutez ce code à une page de votre site pour permettre aux clients potentiels d'effectuer des contrôles de domaine en utilisant ra directement à partir de cette page.";
...
$_ADMINLANG['system']['clickhere'] = "Cliquez ici pour accéder à la zone de téléchargement de ra";
$_ADMINLANG['system']['runninglatestversion'] = "Vous utilisez la dernière version de ra";
...
$_ADMINLANG['license']['reissue1'] = "Si vous envisagez de déplacer votre système ra vers un nouvel emplacement, vous aurez besoin de rééditer votre autorisation. Consultez";
...
$_ADMINLANG['bans']['onlydomain'] = "Entrez uniquement le domaine - ex. ra.com";
...
$_ADMINLANG['mergefields']['RAlink'] = "Lien vers ra";
$_ADMINLANG['mergefields']['RAadminurl'] = "URL de l'admin ra";
$_ADMINLANG['mergefields']['RAadminlink'] = "Lien vers l'admin ra";
...
$_ADMINLANG['general']['emailaddressinfo'] = "L'adresse email utilisé pour les emails envoyés par ra";
...
$_ADMINLANG['general']['systemurl'] = "L'URL du système ra";
$_ADMINLANG['general']['systemurlinfo'] = "L'URL d'installation de ra, ex.";
$_ADMINLANG['general']['sslurl'] = "L'URL SSL du système ra";
$_ADMINLANG['general']['sslurlinfo'] = "URL de l'installation ra pour un accès sécurisé, ex. https://www.yourdomain.com/members/ (laisser vide sinon)";
$_ADMINLANG['general']['template'] = "Thème";
$_ADMINLANG['general']['templateinfo'] = "Le thème que vous voulez utiliser avec ra";
...
$_ADMINLANG['general']['dateformatinfo'] = "Le format que vous désirez utiliser dans ra";
...
$_ADMINLANG['general']['builtin'] = "Système inclut dans ra";
...
$_ADMINLANG['general']['kbseourlsinfo'] = "Cocher pour établir les urls SEO friendly (Requiert que vous renommiez le fichier htaccess.txt en .htaccess dans le répertoire principal de ra)";
...
$_ADMINLANG['utilitiesresolvercheck']['pagedesc'] = "Cet utilitaire vous permet de vérifier que l'adresse IP de chaque domaine de votre système pointe vers ra. Cela vous permet de voir facilement quels domaines ne pointent vers vos serveurs, et donc identifier les clients qui n'utilisent plus votre service afin de libérer des ressources.";
...
$_ADMINLANG['ticketstatusconfig']['pagedesc'] = "Ici, vous pouvez définir les statuts de ticket que votre système ra affiche. Les 4 états de défaut Ouvert, traité, réponse-client et fermé ne peuvent pas être supprimé ou renommé.";

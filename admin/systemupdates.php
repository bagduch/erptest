...
if (!$licensing->getLatestVersion()) {
	...
	if ($CONFIG['Version'] != $licensing->getLatestVersion()) {
		infoBox($aInt->lang("system", "updatecheck"), $aInt->lang("system", "upgrade") . " <a href=\"https://www.ra.com/members/clientarea.php\" target=\"_blank\">" . $aInt->lang("system", "clickhere") . "</a>");
	}
	else {

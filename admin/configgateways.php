...
require "../init.php";
$aInt = new RA_Admin("Configure Payment Gateways");
	...
	if (((trim($file) && $file != "index.php") && $fileext[1] == "php") && !in_array($fileext[0], $includedmodules)) {
		...
		if (!isValidforPath($fileext[0])) {
			exit("Invalid Gateway Module Name");
                ...
                //echo  ROOTDIR . "/modules/gateways/" . $fileext[0] . ".php";

                if (!is_dir(ROOTDIR . ("/modules/gateways/" . $fileext[0] . ".php")))
                {
...
echo $infobox;
echo "<p>" . $aInt->lang("gateways", "intro") . " <a href=\"http://docs.ra.com/Creating_Modules\" target=\"_blank\">http://docs.ra.com/Creating_Modules</a></p>";
echo "
<p>";

        ...
        while ($data = mysqli_fetch_array($result)) {
            ...
            if (!$disable_clients_list_services_summary) {
                ...
                $query = "SELECT
                    ...
                    FROM tblcustomerservices as tcs INNER JOIN ra_catalog AS ts ON tcs.packageid=ts.id INNER JOIN ra_catalog_groups as tsg on ts.gid=tsg.id WHERE tsg.type='service' AND tcs.userid=" . (int) $id;

...
include dirname(__FILE__) . "/includes/classes/class.printInvoice.php";
...
if ($type == "i" || $type == "l") {
    ...
    $pdfinvoice = new PrintInvoice($id, $invoicenum);
    if ($type == "i") {
        $pdfinvoice->printInvoicePdf($viewpdf);
    } else {
        $pdfinvoice->printLateFeePdf($viewpdf);
    }
} elseif ($type == "a") {

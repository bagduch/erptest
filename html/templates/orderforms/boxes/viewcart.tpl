...
{/foreach}
<tr class="carttableconfig"><td><a href="{$smarty.server.PHP_SELF}?a=confservice&i={$num}" class="textgreen">[{$LANG.carteditproductconfig}]</a> <a href="#" onclick="removeItem('p','{$num}');return false" class="textred">[{$LANG.cartremove}]</a></td><td>&nbsp;</td></tr>
{/foreach}

...
<div id="order-modern">
    ...
    <div id="categories">
        ...
        {/if}
        {if $registerdomainenabled && $domain neq "register"}<a href="cart.php?a=adds&domain=register">{$LANG.registerdomain}</a>{/if}
        {if $transferdomainenabled && $domain neq "transfer"}<a href="cart.php?a=adds&domain=transfer">{$LANG.transferdomain}</a>{/if}
    ...
    {foreach from=$products key=num item=product}
        <div class="products">
            <div class="product" id="product{$num}" onclick="window.location = 'cart.php?a=adds&{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}'">
                <table class="border">
                    <tr>
                        <td> 
                            <div class="name">
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="cart.php?a=adds&{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}">

...
echo "</td><td>{\$company_logo_url}</a></td></tr>\r\n<tr><td><a href=\"#\" onclick=\"insertMergeField('RA_url');return false\">";
echo $aInt->lang( "mergefields", "RAurl" );
echo "</td><td>{\$ra_url}</a></td></tr>\r\n<tr><td><a href=\"#\" onclick=\"insertMergeField('RA_link');return false\">";
echo $aInt->lang( "mergefields", "RAlink" );
echo "</td><td>{\$ra_link}</a></td></tr>\r\n";

if ($type == "admin") {
	echo "<tr><td><a href=\"#\" onclick=\"insertMergeField('RA_Admin_url');return false\">";
	echo $aInt->lang( "mergefields", "RAadminurl" );
	echo "</td><td>{\$ra_Admin_url}</a></td></tr>\r\n<tr><td><a href=\"#\" onclick=\"insertMergeField('RA_Admin_link');return false\">";
	echo $aInt->lang( "mergefields", "RAadminlink" );
	echo "</td><td>{\$ra_Admin_link}</a></td></tr>\r\n";
}

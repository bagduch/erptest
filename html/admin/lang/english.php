...
$_ADMINLANG['home']['RAnewsfeed'] = "ra News Feed";
...
$_ADMINLANG['clientsummary']['services'] = "Services";
$_ADMINLANG['clientsummary']['description'] = "Description";
...
$_ADMINLANG['services']['noproducts'] = "No Services";
$_ADMINLANG['services']['noproductsinfo'] = "No services found for this user.";
...
$_ADMINLANG['support']['permissionswarninfo'] = "The downloads folder is not writable by ra so you cannot upload files";
...
$_ADMINLANG['setup']['customfield'] = "View Customise Field";
...
$_ADMINLANG['addonmodules']['description'] = "This is where you can activate and manage addon modules in your ra installation. Older legacy modules will still allow you to activate/deactivate and configure access rights, but will not be able to show any configuration options, version or author information.";
...
#services
$_ADMINLANG['services']['associateddl'] = "Associated Download";
$_ADMINLANG['services']['welcomeemail'] = "Welcome Email";
$_ADMINLANG['services']['title'] = "Services";
$_ADMINLANG['services']['description'] = "This is where you configure all your services and services. Each service must be assigned to a group which can either be visible or hidden from the order page (services may also be hidden individually). A product which is in a hidden group can still be ordered using the Direct Order Link shown when editing the package.";
$_ADMINLANG['services']['createnewgroup'] = "Create a New Group";
$_ADMINLANG['services']['createnewservice'] = "Create a New Service";
$_ADMINLANG['services']['duplicateservice'] = "Duplicate a Service";
$_ADMINLANG['services']['deleteserviceconfirm'] = "Are you sure you want to delete this Service?";
$_ADMINLANG['services']['deletegroupconfirm'] = "Are you sure you want to delete this service group?";
$_ADMINLANG['services']['deletecustomfieldconfirm'] = "Are you sure you want to delete this field and ALL DATA associated with it?";
$_ADMINLANG['services']['deleteproductconfigconfirm'] = "Are you sure you want to delete this service configuration?";
$_ADMINLANG['services']['deletegrouperror'] = "You cannot delete a service group that contains services.";
$_ADMINLANG['services']['deleteserviceerror'] = "You cannot delete a service that is in use.  To delete the service, you need to first re-assign or remove the services using it.";
$_ADMINLANG['services']['servicename'] = "Service Name";
$_ADMINLANG['services']['customegroup'] = "Custom Field";
$_ADMINLANG['services']['servicegroup'] = "Service Group";
$_ADMINLANG['services']['servicegroupname'] = "Service Group Name";
$_ADMINLANG['services']['paytype'] = "Pay Type";
$_ADMINLANG['services']['stock'] = "Stock";
$_ADMINLANG['services']['autosetup'] = "Auto Setup";
$_ADMINLANG['services']['navmoveup'] = "Move Up";
$_ADMINLANG['services']['navmovedown'] = "Move Down";
$_ADMINLANG['services']['navdel'] = "Delete";
$_ADMINLANG['services']['asetupafteracceptpendingorder'] = "After Accepting Pending Order";
$_ADMINLANG['services']['asetupinstantlyafterorder'] = "Instantly After Order";
$_ADMINLANG['services']['asetupinstantlyafterorderdesc'] = "Automatically setup the service as soon as an order is placed";
$_ADMINLANG['services']['asetupafterpay'] = "After First Payment";
$_ADMINLANG['services']['asetupafterpaydesc'] = "Automatically setup the service as soon as the first payment is received";
$_ADMINLANG['services']['asetupmadesc'] = "Automatically setup the service when you manually accept a pending order";
$_ADMINLANG['services']['noautosetupdesc'] = "Do not automatically setup this service";
$_ADMINLANG['services']['off'] = "Off";
$_ADMINLANG['services']['proratabilling'] = "Prorata Billing";
$_ADMINLANG['services']['hostingaccount'] = "Hosting Account";
$_ADMINLANG['services']['reselleraccount'] = "Reseller Account";
$_ADMINLANG['services']['dedicatedvpsserver'] = "Dedicated/VPS Server";
$_ADMINLANG['services']['otherserviceservice'] = "Other Service";
$_ADMINLANG['services']['noservicesingroupsetup'] = "No services Setup in this Group";
$_ADMINLANG['services']['nogroupssetup'] = "No Service Groups Setup";
$_ADMINLANG['services']['editproduct'] = "Edit Service";
$_ADMINLANG['services']['tabsdetails'] = "Details";
$_ADMINLANG['services']['tabsmodulesettings'] = "Module Settings";
$_ADMINLANG['services']['tabsupgrades'] = "Upgrades";
$_ADMINLANG['services']['tabsfreedomain'] = "Free Domain";
$_ADMINLANG['services']['tabslinks'] = "Links";
$_ADMINLANG['services']['servicedesc'] = "Service Description";
$_ADMINLANG['services']['htmlallowed'] = "You may use HTML in this field";
$_ADMINLANG['services']['htmlnewline'] = "New line";
$_ADMINLANG['services']['htmlbold'] = "Bold";
$_ADMINLANG['services']['htmlitalics'] = "Italics";
$_ADMINLANG['services']['requiredomain'] = "Require Domain";
$_ADMINLANG['services']['domainregoptionstick'] = "Tick to show domain registration options";
$_ADMINLANG['services']['stockcontrol'] = "Stock Control";
$_ADMINLANG['services']['stockcontroldesc'] = "Enable - Quantity in Stock";
$_ADMINLANG['services']['sortorder'] = "Sort Order";
$_ADMINLANG['services']['sortorderdesc'] = "Enter a number here to override the default sorting on the order form";
$_ADMINLANG['services']['applytax'] = "Apply Tax";
$_ADMINLANG['services']['applytaxdesc'] = "Tick this box to charge tax for this Service";
$_ADMINLANG['services']['hiddendesc'] = "Tick to hide from order form";
$_ADMINLANG['services']['retired'] = "Retired";
$_ADMINLANG['services']['retireddesc'] = "Tick to hide from admin area service dropdown menus (does not apply to services already with this service)";
$_ADMINLANG['services']['contract'] = "Contract";
$_ADMINLANG['services']['contractdes'] = "Tick if this service is contract";
$_ADMINLANG['services']['etf'] = "ETF";
$_ADMINLANG['services']['term'] = "Term";
$_ADMINLANG['services']['paymenttype'] = "Payment Type";
$_ADMINLANG['services']['disablepaymenttermdesc'] = "Set Price to -1.00 to disable any of the payment term options - leave Setup Fee at zero";
$_ADMINLANG['services']['allowqty'] = "Allow Multiple Quantities";
$_ADMINLANG['services']['allowqtydesc'] = "Tick this box to allow customers to specify if they want more than 1 of this item when ordering (must not require separate config)";
$_ADMINLANG['services']['recurringcycleslimit'] = "Recurring Cycles Limit";
$_ADMINLANG['services']['recurringcycleslimitdesc'] = "To limit this service to only recur a fixed number of times, enter the total number of times to invoice (0 = Unlimited)";
$_ADMINLANG['services']['autoterminatefixedterm'] = "Auto Terminate/Fixed Term";
$_ADMINLANG['services']['autoterminatefixedtermdesc'] = "Enter the number of days after activation to automatically terminate (eg. free trials, time limited services, etc...)";
$_ADMINLANG['services']['terminationemail'] = "Termination Email";
$_ADMINLANG['services']['chooseemailtplfixedtermend'] = "Choose the email template to send when the fixed term comes to an end";
$_ADMINLANG['services']['tickboxtoenable'] = "Tick this box to enable";
$_ADMINLANG['services']['proratadate'] = "Prorata Date";
$_ADMINLANG['services']['proratadatedesc'] = "Enter the day of the month you want to charge on";
$_ADMINLANG['services']['chargenextmonth'] = "Charge Next Month";
$_ADMINLANG['services']['chargenextmonthdesc'] = "Enter the day of the month after which point the following month will also be charged for with the first payment";
$_ADMINLANG['services']['modulename'] = "Module Name";
$_ADMINLANG['services']['servergroup'] = "Server Group";
$_ADMINLANG['services']['assignedoptiongroups'] = "Assigned Option Groups";
$_ADMINLANG['services']['packagesupgrades'] = "Packages Upgrades";
$_ADMINLANG['services']['usectrlclickpkgs'] = "Use Ctrl+Click to select multiple packages";
$_ADMINLANG['services']['usectrlclickpayterms'] = "Use Ctrl + Click to select multiple payment terms and TLD's";
$_ADMINLANG['services']['tickboxallowconfigoptupdowngrades'] = "Tick this box to allow Upgrading/Downgrading of configurable options";
$_ADMINLANG['services']['upgradechargefullcycle'] = "Charge Full Cycle";
$_ADMINLANG['services']['upgradechargefullcyclelabel'] = "Tick this box to charge a full cycle on upgrades/downgrades of this service";
$_ADMINLANG['services']['upgradeemail'] = "Upgrade Email";
$_ADMINLANG['services']['freedomainrenewnormal'] = "Offer a free domain registration/transfer only (renew as normal)";
$_ADMINLANG['services']['freedomainfreerenew'] = "Offer a free domain registration/transfer and free renewal (if service is renewed)";
$_ADMINLANG['services']['freedomainpayterms'] = "Free Domain Payment Terms";
$_ADMINLANG['services']['selectfreedomainpayterms'] = "Select the payment term(s) the service must be paid with to receive a free domain";
$_ADMINLANG['services']['selectfreedomainpayterms'] = "Free Domain TLD's";
$_ADMINLANG['services']['customaffiliatepayout'] = "Custom Affiliate Payout";
$_ADMINLANG['services']['subdomainoptions'] = "Subdomain Options";
$_ADMINLANG['services']['subdomainoptionsdesc'] = "Enter in the format .yourdomain.com (comma seperated list supported for multiple options)";
$_ADMINLANG['services']['associateddownloads'] = "Associated Downloads";
$_ADMINLANG['services']['associateddownloadsdesc'] = "This is where you can specify files that are granted access to by purchasing this service.";
$_ADMINLANG['services']['availablefiles'] = "Available Files";
$_ADMINLANG['services']['selectedfiles'] = "Selected Files";
$_ADMINLANG['services']['overagesbilling'] = "Overages Billing";
$_ADMINLANG['services']['overagediskusage'] = "Disk Usage";
$_ADMINLANG['services']['overagebandwidth'] = "Bandwidth";
$_ADMINLANG['services']['overagesoftlimits'] = "Soft Limits";
$_ADMINLANG['services']['overagecosts'] = "Overage Costs";
$_ADMINLANG['services']['priceperunit'] = "Price Per Unit Over Above";
$_ADMINLANG['services']['directcartlink'] = "Direct Cart Link";
$_ADMINLANG['services']['directscartlink'] = "Direct Shopping Cart Link";
$_ADMINLANG['services']['directscarttpllink'] = "Direct Shopping Cart Link Specifying Template";
$_ADMINLANG['services']['directscartdomlink'] = "Direct Shopping Cart Link Including Domain";
$_ADMINLANG['services']['servicegcartlink'] = "Service Group Cart Link";
$_ADMINLANG['services']['ajaxspoflink'] = "Ajax Single Page Order Form Link";
$_ADMINLANG['services']['backtoservicelist'] = "Back to Service List";
$_ADMINLANG['services']['addnewproduct'] = "Add New Service";
$_ADMINLANG['services']['duplicateservice'] = "Duplicate Service";
$_ADMINLANG['services']['existingservice'] = "Existing Service";
$_ADMINLANG['services']['newservicename'] = "New Service Name";
$_ADMINLANG['services']['orderfrmtpl'] = "Order Form Template";
$_ADMINLANG['services']['availablepgways'] = "Available Payment Gateways";
$_ADMINLANG['services']['hiddengroupdesc'] = "Check this box if this is a hidden group";
$_ADMINLANG['services']['creategroup'] = "Create Group";
$_ADMINLANG['services']['editgroup'] = "Edit Group";
$_ADMINLANG['services']['addcategory'] = "Add Category";
$_ADMINLANG['services']['quickupload'] = "Quick Upload";
$_ADMINLANG['services']['updatesort'] = "Update Sorting";
...
$_ADMINLANG['products']['customegroup'] = "Custom Field";
...
$_ADMINLANG['adminroles']['description'] = "The administrator roles allow you to fine tune exactly what each of your admin users can do within the ra admin area.";
...
# Payment Gateways
$_ADMINLANG['gateways']['intro'] = "This is where you configure the payment methods/gateways you want to offer & accept from your clients. If the gateway you want to use is not listed here, then you can build your own modules for RA- the docs for which can be found @";
...
$_ADMINLANG['system']['integrationinfo'] = "The following HTML code snippets can be added to your website to integrate with your ra System.";
$_ADMINLANG['system']['widgetsinfo'] = "Widgets are another useful tool we provide to allow you to add dynamic output to your website live from ra. For example these can be used to display product descriptions and pricing that auto updates on your site when changes are made through ra. For more information, please see";
$_ADMINLANG['system']['intclientlogin'] = "Clients Login";
$_ADMINLANG['system']['intclientlogininfo'] = "Add this code to a page on your site to display a clients login form to log clients into the ra Client Area";
$_ADMINLANG['system']['intdalookup'] = "Domain Availability Lookup";
$_ADMINLANG['system']['intdalookupinfo'] = "Add this code to a page on your site to allow potential clients to perform domain checks using ra directly from that page.";
...
$_ADMINLANG['system']['clickhere'] = "Click here to go to the ra Client Download Area";
$_ADMINLANG['system']['runninglatestversion'] = "You are running the latest version of ra";
...
# Support Request
$_ADMINLANG['supportreq']['title'] = "Get Help with ra";
...
$_ADMINLANG['mergefields']['RAurl'] = "ra URL";
$_ADMINLANG['mergefields']['RAlink'] = "ra Link";
$_ADMINLANG['mergefields']['RAadminurl'] = "ra admin url";
$_ADMINLANG['mergefields']['RAadminlink'] = "ra admin link";
...
$_ADMINLANG['general']['emailaddressinfo'] = "The default sender address used for emails sent by ra";
...
$_ADMINLANG['general']['systemurl'] = "ra System URL";
$_ADMINLANG['general']['systemurlinfo'] = "URL of the ra installation, eg.";
$_ADMINLANG['general']['sslurl'] = "ra SSL System URL";
$_ADMINLANG['general']['sslurlinfo'] = "URL of the ra installation for secure access, eg. https://www.yourdomain.com/members/ (leave blank for no SSL)";
$_ADMINLANG['general']['template'] = "Template";
$_ADMINLANG['general']['templateinfo'] = "The template you want ra to use";
...
$_ADMINLANG['general']['builtin'] = "ra Built-in System";
...
$_ADMINLANG['general']['apirestrictioninfo'] = "IP Addresses allowed to connect to the ra API";
...
$_ADMINLANG['general']['defaulttoclientareainfo'] = "Tick this box to skip the homepage and forward users directly to the client area/login form upon first visiting ra";
...
$_ADMINLANG['general']['csrftoken.RA.default'] = "CSRF Tokens: General";
$_ADMINLANG['general']['csrftoken.ra.defaultinfo'] = "Tick to enable general use of CSRF tokens for all public and clientarea forms (Highly Recommended)";
$_ADMINLANG['general']['csrftoken.ra.domainchecker'] = "CSRF Tokens: Domain Checker";
$_ADMINLANG['general']['csrftoken.ra.domaincheckerinfo'] = "Tick to enable use of CSRF tokens for the Domain Checker form";
...
$_ADMINLANG['utilitiesresolvercheck']['pagedesc'] = "This utility allows you to check the IP address each domain in your ra system is pointing to. This allows you to easily see which domains are no longer pointing at your servers and therefore identify clients that may no longer be using your service in order to free up resources.";
...
$_ADMINLANG['utilitiesresolvercheck']['delsureterminateonserver'] = "Are you sure you want to do this? This will send the module terminate command to the remote server (deleting all files), as well as change the status in ra to Terminated to stop any future billing.";
...
$_ADMINLANG['massmail']['servicestatus'] = "Domain Status";
...
$_ADMINLANG['configservers']['statusaddressdesc'] = "To display this server on the server status page, enter the full path to the server status folder (required to be uploaded to each server you want to monitor) - eg. http://www.ra.com/status/";
...
$_ADMINLANG['configservers']['pagedesc'] = "This is where you configure all your servers so that ra can communicate with them. The default server for each module is marked with an asterisk *. You must select a default server for automatic setup to function correctly.";
...
$_ADMINLANG['twofa']['activateintro'] = "Two-factor authentication adds an extra layer of protection to your account.  Once enabled, every time you sign in to the ra admin area, you'll need to enter both your username & password as well as a second factor such as a security code.";

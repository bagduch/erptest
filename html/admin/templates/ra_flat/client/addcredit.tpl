...
<div class="card">
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="clientscredits.php?userid={$userid}&amp;sub={$action}">
                ...
                <div class="content">
                    ...
                    <table class="table" width="100%" border="0" cellspacing="2" cellpadding="3">
                        <tbody>
                            <tr><td width="15%" class="fieldlabel">Date</td><td class="fieldarea"><input class="form-control datepick" type="text" name="date" size="12" value="{$today}"></td></tr>

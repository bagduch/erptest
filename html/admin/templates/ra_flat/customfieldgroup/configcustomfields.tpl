            ...
            <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fieldarea">
                            <input type="text" name="description[{$num}]" size="60"> The explanation to show users
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldlabel">Validation</td>
                        <td class="fieldarea">
                            <input type="text" name="regexpr[{$num}]" size="60"> Regular Expression Validation String
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldlabel">Select Options</td>
                        <td class="fieldarea">
                            <input type="text" name="fieldoptions[{$num}]" size="60"> For Dropdowns Only - Comma Seperated List</td>
                    </tr>
                    <tr>
                        <td class="fieldlabel"></td>
                        <td class="fieldarea">
                            <input type="checkbox" name="adminonly[{$num}]"> Admin Only 
                            <input type="checkbox" name="required[{$num}]"> Required Field 
                            <input type="checkbox" name="showorder[{$num}]"> Show on Order Form 
                            <input type="checkbox" name="showinvoice[{$num}]"> Show on Invoice
                        </td>
                    </tr>
                </tbody>
            </table>

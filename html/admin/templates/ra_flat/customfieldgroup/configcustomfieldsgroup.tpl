...
<div class="card">
    ...
    <div class="content">
        ...
        <p> <b>Options:</b> <a class="btn btn-default" href="/admin/configcustomfieldsgroup.php?action=managegroup">Create a Customer Field Group</a> | <a class="btn btn-default" href="/admin/configcustomfieldsgroup.php?action=duplicategroup">Duplicate a Group</a>
        </p>
        <div class="tablebg">

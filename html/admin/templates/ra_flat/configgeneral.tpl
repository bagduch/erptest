        ...
        <div class="card">
            <div class="content">
                <form method="post" action="{$PHP_SELF}?action=save" name="configfrm">
                    ...
                    <p align="center">
                        <input type="submit" value="Save Changes" class="btn btn-default"></p>

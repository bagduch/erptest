...
require "../init.php";
$aInt = new RA_Admin("View Reports");
$aInt->title = "Reports";
$aInt->sidebar = "reports";
$aInt->icon = "reports";
$menuselect = "$('#menu').multilevelpushmenu('expand','Reports');";
$aInt->requiredFiles(array("reportfunctions"));
$report = $ra->get_req_var("report");
$displaygraph = $ra->get_req_var("displaygraph");
...
if ($print) {
    echo "<html>
<head>
<title>Robotic Accounting - Printer Friendly Report</title>

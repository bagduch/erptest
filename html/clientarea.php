...
if ($action == "transection") {
    $ca->addToBreadCrumb("clientarea.php?action=transection", $ra->get_lang("transection"));
}
...
if ($action == "") {
    ...
    $smartyvalues = array_merge($smartyvalues, clientAreaTablePageNav($numitems));
} elseif ($action == "descriptiondetails") {
    checkContactPermission("descriptions");
...
} elseif ($action == "descriptioncontacts") {
    checkContactPermission("managedescriptions");
...
} elseif ($action == "descriptionemailforwarding") {
    checkContactPermission("managedescriptions");
...
} elseif ($action == "descriptiongetepp") {
    checkContactPermission("managedescriptions");
...
} elseif ($action == "descriptionregisterns") {
    checkContactPermission("managedescriptions");
...
} elseif ($action == "descriptionrenew") {
...
} elseif ($action == "descriptionaddons") {
    check_token();

...
function licensing_CreateAccount($params) {
	if (!LICENSINGADDONLICENSE) {
		return "Your ra license key is not enabled to use the Licensing Addon yet. Navigate to Addons > Licensing Manager to resolve.";
	}

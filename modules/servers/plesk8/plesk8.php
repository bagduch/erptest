...
function plesk8_ConfigOptions() {
	$configarray = array( "Client Template Name" => array( "Type" => "text", "Size" => "25" ), "Domain Template Name" => array( "Type" => "text", "Size" => "25" ), "IP Address" => array( "Type" => "text", "Size" => "20", "Description" => "Only required if instructed by ra Support" ) );
	return $configarray;
}

...
";
	$result = select_query( "tblcustomerservices", "tblcustomerservices.id,tblservices.id AS pid,tblservices.name,tblservicegroups.name AS groupname,tblcustomerservices.firstpaymentamount", array( "orderid" => $orderid ), "", "", "", "tblservices ON tblservices.id=tblcustomerservices.packageid INNER JOIN tblservicegroups ON tblservicegroups.id=tblservices.gid" );

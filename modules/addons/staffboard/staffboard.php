...
function staffboard_config() {
	$configarray = array("name" => "Staff Noticeboard", "version" => "1.1", "author" => "ra", "description" => "Acts as a noticeboard within the ra admin area providing a quick and easy way to communicate with all the staff via your ra system");

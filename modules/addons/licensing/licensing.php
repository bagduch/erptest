...
function licensing_output($vars) {
	...
	if (!LICENSINGADDONLICENSE) {
		if ($ra->get_req_var("refresh")) {
			$licensing->forceRemoteCheck();
			redir("module=licensing");
		}

		echo "<div class=\"gracefulexit\">
Your ra license key is not enabled to use the Licensing Addon yet.<br /><br />
You can find out more about it and purchase @ <a href=\"http://go.ra.com/94/licensing-addon\" target=\"_blank\">www.ra.com/addons/licensing-addon</a><br /><br />
...
<a href=\"" . $modulelink . "\">Home</a> | <a href=\"" . $modulelink . "&action=list\">Search/Browse Licenses</a> | <a href=\"" . $modulelink . "&action=bans\">Ban Control</a> | <a href=\"" . $modulelink . "&action=log\">License Access Logs</a> | <a href=\"http://docs.ra.com/Licensing_Addon\" target=\"_blank\">Help</a>
</div>
...
<tr><td width=\"15%\" class=\"fieldlabel\">Product/License</td><td class=\"fieldarea\">";
		...
		$result = select_query("tblservices", "id,name", array("servertype" => "licensing"), "name", "ASC");

...
function project_management_config() {
	$configarray = array("name" => "Project Management", "version" => "1.1", "author" => "ra", "language" => "english", "description" => "Track & manage projects, tasks & time with ease using the Official Project Management Addon for ra.<br />Find out more & purchase @ <a href=\"http://go.ra.com/90/project-management\" target=\"_blank\">www.ra.com/addons/project-management</a>", "premium" => true, "fields" => array());

	if (!PMADDONLICENSE) {
		$configarray['fields']['license'] = array("FriendlyName" => "License Check Failed", "Type" => "", "Description" => "You need to purchase the project management addon from <a href=\"http://go.ra.com/90/project-management\" target=\"_blank\">www.ra.com/addons/project-management</a> before you can use this functionality. If you just purchased it recently, please <a href=\"configaddonmods.php?pmrefresh=1#project_management\">click here</a> to refresh this message");
	}
...
Your ra license key is not enabled to use the Project Management Addon yet.<br /><br />
You can find out more about it and purchase @ <a href=\"http://go.ra.com/90/project-management\" target=\"_blank\">www.ra.com/addons/project-management</a><br /><br />
...
<div align=\"center\"><input type=\"submit\" value=\"" . $vars['_lang']['create'] . "\" class=\"create\" />&nbsp;<input type=\"button\" value=\"" . $vars['_lang']['cancel'] . "\" class=\"create\" onclick=\"cancelnewproject();return false\" /></div>
	...
	$headeroutput .= "<a href=\"http://docs.ra.com/Project_Management\"><img src=\"images/icons/support.png\" /> " . $vars['_lang']['help'] . "</a></div>

...
function getResultsArray($results) {
	...
	foreach ($results as $value) {
		...
		$result[1] = str_replace("http://www.maxmind.com/app/ccv2r_signup", "http://www.maxmind.com/app/ccfd_promo?promo=RA4562", $result[1]);

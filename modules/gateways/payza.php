...
function payza_config() {
	...
	update_query( "tblcustomerservices", array( "paymentmethod" => "payza" ), array( "paymentmethod" => "alertpay" ) );
	...
	full_query( "UPDATE tblservicegroups SET disabledgateways = REPLACE(disabledgateways, 'alertpay', 'payza')" );

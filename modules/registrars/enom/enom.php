...
function enom_getConfigArray() {
	$configarray = array( "Description" => array( "Type" => "System", "Value" => "Don't have an Enom Account yet? Get one here: <a href=\"http://go.ra.com/82/enom\" target=\"_blank\">www.ra.com/partners/enom</a>" ), "Username" => array( "Type" => "text", "Size" => "20", "Description" => "Enter your Enom Reseller Account Username here" ), "Password" => array( "Type" => "password", "Size" => "20", "Description" => "Enter your Enom Reseller Account Password here" ), "TestMode" => array( "Type" => "yesno" ), "DefaultNameservers" => array( "Type" => "yesno", "Description" => "Tick this box to use the default Enom nameservers for new domain registrations" ) );
	return $configarray;
}

...
function resellone_GetNameservers($params) {
	...
	if (!class_exists( "PEAR" )) {
		return array( "error" => "OpenSRS/ResellOne Class Files Missing. Visit <a href=\"http://docs.ra.com/OpenSRS#Additional_Registrar_Module_Files_Requirement\" target=\"_blank\">http://docs.ra.com/OpenSRS#Additional_Registrar_Module_Files_Requirement</a> to resolve" );
	}

...
$result = select_query("tblhosting","tblhosting.*,tblclients.firstname,tblclients.lastname,tblservices.name",array("domainstatus"=>"Suspended"),"id","ASC","","tblclients ON tblclients.id=tblhosting.userid INNER JOIN tblservices ON tblservices.id=tblhosting.packageid");

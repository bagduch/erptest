...
<div class="box box-success">
    <div class="box-body">
        <form method="post" action="<?php echo $this->_tpl_vars['formurl']; ?>
?action=add">
            <div class="col-md-6">
                        ...
                        <tr>
                            <td class="fieldlabel">Security Question</td><td class="fieldarea">
                                <select name="securityqid"  class="form-control"  style="width:225px;" tabindex="6">
                                    ...
                                    <?php echo $this->_tpl_vars['securityoption']; ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fieldlabel">Country</td><td class="fieldarea">
                                <?php echo $this->_tpl_vars['countrydrop']; ?>
                        ...
                        <tr>
                            <td class="fieldlabel">Payment Method</td><td class="fieldarea">
                                <?php echo $this->_tpl_vars['paymentmethoddrop']; ?>
                        ...
                        <tr>
                            ...
                            <td class="fieldarea">
                                <select class="form-control" name="billingcid" tabindex="21">
                                    ...
                                    <?php echo $this->_tpl_vars['contactoption']; ?>
                        ...
                        <tr>
                            ...
                            <td class="fieldarea">
                                <select class="form-control" name="language" tabindex="22">
                                    <option value="">Default</option>
                                    <?php echo $this->_tpl_vars['langoption']; ?>
                        ...
                        <tr>
                            ...
                            <td class="fieldarea">
                                <select class="form-control" name="currency" tabindex="24">
                                    <?php echo $this->_tpl_vars['currencyoption']; ?>

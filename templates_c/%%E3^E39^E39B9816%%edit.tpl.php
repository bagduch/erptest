...
"><?php echo $this->_tpl_vars['invoice']['firstname']; ?>
 <?php echo $this->_tpl_vars['invoice']['lastname']; ?>
</a> 
                                            (<a href="clientsinvoices.php?userid=<?php echo $this->_tpl_vars['invoice']['userid']; ?>
">View Invoices</a>)
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="fieldlabel">Invoice Date</td>
                                        <td class="fieldarea"><?php echo $this->_tpl_vars['invoice']['date']; ?>
</td>
                                    </tr>
                                    <tr>
                                        <td class="fieldlabel">Due Date</td>
                                        <td class="fieldarea"><?php echo $this->_tpl_vars['invoice']['duedate']; ?>
</td>
                                    </tr>
                                    <tr>
                                        <td class="fieldlabel">Total Due</td>
                                        <td class="fieldarea"><?php echo $this->_tpl_vars['invoice']['totalcurrency']; ?>
</td>
                                    </tr>
                                    <tr>
                                        <td class="fieldlabel">Balance</td>
                                        <td class="fieldarea"><b><font color="#cc0000"><?php echo $this->_tpl_vars['balancecurrency']; ?>
</font></b></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <span class="invoicestatus Unpaid"><?php echo $this->_tpl_vars['invoice']['status']; ?>
</span>
                            <br>Payment Method: <b><?php echo $this->_tpl_vars['invoice']['paymentmethod']; ?>
</b>
                            <br><img src="images/spacer.gif" width="1" height="10"><br>
                            <form method="post" action="invoices.php?action=edit&id=<?php echo $this->_tpl_vars['invoice']['id']; ?>
">
                ...
                <table class="form table" width="100%" border="0" cellspacing="2" cellpadding="3">
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldarea"><input type="text" name="date" value="<?php echo $this->_tpl_vars['invoice']['date']; ?>
" class="datepick form-control"></td>
                            <td width="20%" class="fieldlabel">Amount</td>
                            <td class="fieldarea"><input type="text" form-control name="amount" value="<?php echo $this->_tpl_vars['balance']; ?>
" size="10"></td>
                        </tr>
                        <tr>
                            ...
                            <td class="fieldarea"><input type="text" class="form-control" name="fees" value="<?php echo $this->_tpl_vars['invoice']['fees']; ?>
" size="10"></td></tr>
                        <tr>
                ...
                <table class="form table" width="100%" border="0" cellspacing="2" cellpadding="3">
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldarea"><input type="text" name="invoicedate" value="<?php echo $this->_tpl_vars['invoice']['date']; ?>
" class="datepick form-control"></td>
                            <td width="20%" class="fieldlabel">Due Date</td>
                            <td class="fieldarea"><input type="text" name="datedue" value="<?php echo $this->_tpl_vars['invoice']['duedate']; ?>
" class="datepick form-control"></td>
                        </tr>
                        <tr>
                            <td class="fieldlabel">Payment Method</td>
...
">
    ...
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['detail']):
?>
                    <tr>
                        <td width="20" align="center">
                            <input type="checkbox" name="itemids[]" value="<?php echo $this->_tpl_vars['id']; ?>
">
                        </td>
                        <td>
                            <textarea class="form-control" name="description[<?php echo $this->_tpl_vars['id']; ?>
]" style="width:98%" rows="<?php echo $this->_tpl_vars['detail']['linecount']; ?>
"><?php echo $this->_tpl_vars['detail']['description']; ?>
</textarea>
                        </td>
                        <td align="center" nowrap="">
                            <input class="form-control" type="text" name="amount[<?php echo $this->_tpl_vars['id']; ?>
]" value="<?php echo $this->_tpl_vars['detail']['amount']; ?>
" size="10" style="text-align:center">
                        </td>
                        <td align="center"><input type="checkbox" name="taxed[<?php echo $this->_tpl_vars['id']; ?>
]" value="1" <?php if ($this->_tpl_vars['detail']['taxed']): ?>checked<?php endif; ?>></td>
                        <td width="20" align="center">
                            <a href="#" onclick="doDelete('<?php echo $this->_tpl_vars['id']; ?>
')">
                ...
                <tr>
                    ...
                    <td width="90" style="background-color:#efefef;"><strong><?php echo $this->_tpl_vars['invoice']['subtotalcurrency']; ?>
</strong></td>
                ...
                <tr>
                    ...
                    <td width="90" style="background-color:#efefef;"><?php echo $this->_tpl_vars['invoice']['creditcurrency']; ?>
</td>
                    <td style="background-color:#efefef;">&nbsp;</td>
                    <td style="background-color:#efefef;">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <th width="90"><?php echo $this->_tpl_vars['invoice']['totalcurrency']; ?>
</th>
                    <th></th>
                    <th></th>
                </tr>
...
?>
                <td><?php echo $this->_tpl_vars['transaction']['date']; ?>
</td>
                <td><?php echo $this->_tpl_vars['transaction']['gateway']; ?>
</td>
                <td><?php echo $this->_tpl_vars['transaction']['id']; ?>
</td>
                <td><?php echo $this->_tpl_vars['transaction']['amountin']; ?>
</td>
                <td><?php echo $this->_tpl_vars['transaction']['fees']; ?>
</td>
                <a href="#" onclick="doDeleteTransaction(<?php echo $this->_tpl_vars['transaction']['id']; ?>
);"><img src="images/delete.gif" width="16" height="16" border="0" alt="Delete"></a>
                <?php endforeach; endif; unset($_from); ?>
            <?php endif; ?>
        </tbody>
    </table>
...
<?php echo '
    <script type="text/javascript">
        ...
        {
            window.open(\'../viewinvoice.php?id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '\', \'windowfrm\', \'menubar=yes,toolbar=yes,scrollbars=yes,resizable=yes,width=750,height=600\')
        }
        function viewPDF()
        {
            window.open(\'../dl.php?type=i&id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '&viewpdf=1\', \'pdfinv\', \'\')
        }
        function downloadPDF()
        {
            window.location = "../dl.php?type=i&id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '";
        ...
        function markCancelled()
        {
            ...
            {
                window.location = "/admin/invoices.php?action=edit&id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '&sub=statuscancelled&token='; ?>
...
<?php echo '";
        ...
        function markUnpaid()
        {
            if (confirm("Are you sure you want to mark unpaid this invoice?"))
            {
                window.location = "/admin/invoices.php?action=edit&id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '&sub=statusunpaid&token='; ?>
<?php echo $this->_tpl_vars['tokens']; ?>
<?php echo '";
            }
...
<?php echo '&iid=\' + id;
        ...
        function doDeleteTransaction(id) {
            if (confirm("Are you sure you want to delete this transaction?")) {
                window.location = \'/admin/invoices.php?action=edit&id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '&sub=deletetrans&token='; ?>
<?php echo $this->_tpl_vars['tokens']; ?>
<?php echo '&ide=\' + id;
            }
        }
        function attemptpayment() {
            if (confirm("Are you sure you want to attempt payment for this invoice?")) {
                window.location = \'/admin/invoices.php?action=edit&id='; ?>
<?php echo $this->_tpl_vars['invoice']['id']; ?>
<?php echo '&sub=attemptpayment&token='; ?>
<?php echo $this->_tpl_vars['tokens']; ?>
<?php echo '\';
            }
        }

...
*************************************************************************
*                                                                       *
* RA - The Complete Client Management, Billing & Support Solution    *
* Copyright (c) RA Ltd. All Rights Reserved,                         *
...
Status page of the RA Client Area and Admin Area Homepage
...
if ($action=="phpinfo") {
    ...
    */
	...
	$phpver = phpversion();
	$mysqlver = (function_exists("mysqli_get_client_info")) ? mysqli_get_client_info() : '-';

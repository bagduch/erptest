...
) ENGINE=InnoDB AUTO_INCREMENT=8022 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblcustomfields` (
  ...
  `parent_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`cfid`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='Custom fields applied to products and services';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=152059 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

...
$tax = ($tax ? "1" : "0");
$pid = insert_query("tblservices", array("type" => $type, "gid" => $gid, "name" => $name, "description" => $description, "hidden" => $hidden, "showdomainoptions" => $showdomainoptions, "welcomeemail" => $welcomeemail, "stockcontrol" => $stockcontrol, "qty" => $qty, "proratabilling" => $proratabilling, "proratadate" => $proratadate, "proratachargenextmonth" => $proratachargenextmonth, "paytype" => $paytype, "subdomain" => $subdomain, "autosetup" => $autosetup, "servertype" => $module, "servergroup" => $servergroupid, "configoption1" => $configoption1, "configoption2" => $configoption2, "configoption3" => $configoption3, "configoption4" => $configoption4, "configoption5" => $configoption5, "configoption6" => $configoption6, "tax" => $tax, "order" => $order));

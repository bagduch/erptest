...
mysqldump --skip-dump-date -n -t --skip-add-drop-table -B ra --ignore-table=ra.tblclients --ignore-table=ra.tbladminlog --ignore-table=ra.tblemails --ignore-table=ra.tblconfiguration > db/02_robotacct_data.sql
